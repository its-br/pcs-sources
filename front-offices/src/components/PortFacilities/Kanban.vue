...
export default {
    ...
    methods: {
       ...
       * Preenche o Kanban com todas as paradas das viagens, conforme o processo:
       ...
       - Separa os aceites do terminal e das agências secundárias nas variáveis `transportCallAcceptances` e `otherMaritimeAgencyAcceptances`;
       ...
       - Adiciona os objetos de `transportCalls` de cada parada nos arrays para popular as colunas do Kanban a partir da indicação `placementState`;
        Os arrays transportCallsIn(acceptance, preparation etc.) são específicos para popular cada coluna do Kanban. 
      */
      fillKanban(){
        this.clearVariables()        
        this.getVoyages()
